...
var Embed = function () {
	(function (e, t) {
		...
		v.fn = v.prototype = {
			...
			var e,
			    ...
			    f = arguments.length,
			    l = !1;
			typeof u == 'boolean' && (l = u, u = arguments[1] || {}, a = 2), (typeof u === 'undefined' ? 'undefined' : _typeof(u)) != 'object' && !v.isFunction(u) && (u = {}), f === a && (u = this, --a);
			for (; a < f; a++) {
			...
			access: function access(e, n, r, i, s, o, u) {
				var a,
				    ...
				    l = 0,
				    c = e.length;
				if (r && (typeof r === 'undefined' ? 'undefined' : _typeof(r)) == 'object') {
					for (l in r) {
		...
		v.extend({
			...
			data: function data(e, n, r, i) {
				...
				if ((typeof n === 'undefined' ? 'undefined' : _typeof(n)) == 'object' || typeof n == 'function') i ? l[c] = v.extend(l[c], n) : l[c].data = v.extend(l[c].data, n);
		...
		v.event = {
			...
			trigger: function trigger(n, r, s, o) {
				if (!s || s.nodeType !== 3 && s.nodeType !== 8) {
					...
					n = (typeof n === 'undefined' ? 'undefined' : _typeof(n)) == 'object' ? n[v.expando] ? n : new v.Event(y, n) : new v.Event(y), n.type = y, n.isTrigger = !0, n.exclusive = a, n.namespace = b.join('.'), n.namespace_re = n.namespace ? new RegExp('(^|\\.)' + b.join('\\.(?:.*\\.|)') + '(\\.|$)') : null, h = y.indexOf(':') < 0 ? 'on' + y : '';
					if (!s) {
						u = v.cache;
						for (f in u) {
		...
		v.fn.extend({
			...
			style: function style(e, n, r, i) {
				...
				o = typeof r === 'undefined' ? 'undefined' : _typeof(r), o === 'string' && (s = zt.exec(r)) && (r = (s[1] + 1) * s[2] + parseFloat(v.css(e, n)), o = 'number');
			...
			v.cssHooks[t] = {
				get: function get$$1(e, n, r) {
					if (n) return e.offsetWidth === 0 && It.test(Dt(e, 'display')) ? v.swap(e, Xt, function () {
						return tn(e, t, r);
					}) : tn(e, t, r);
				},
				set: function set$$1(e, n, r) {
		...
		ln = wn.exec(cn.toLowerCase()) || [], v.fn.load = function (e, n, r) {
			...
			var i,
			    ...
			    u = this,
			    a = e.indexOf(' ');
			return a >= 0 && (i = e.slice(a, e.length), e = e.slice(0, a)), v.isFunction(n) ? (r = n, n = t) : n && (typeof n === 'undefined' ? 'undefined' : _typeof(n)) == 'object' && (s = 'POST'), v.ajax({
				url: e,
				type: s,
				dataType: 'html',
				data: n,
			...
			ajax: function ajax(e, n) {
				...
				(typeof e === 'undefined' ? 'undefined' : _typeof(e)) == 'object' && (n = e, e = t), n = n || {};
				var r,
				    i,
				    s,
				    o,
		...
		v.Animation = v.extend(Kn, {
			...
			var r = e && (typeof e === 'undefined' ? 'undefined' : _typeof(e)) == 'object' ? v.extend({}, e) : {
	...
	window.ForecastEmbed = function (e) {
		var t = {},
		    ...
		    getWeekDays = function getWeekDays(locale) {
